...
class TestAlbumPictureAdminAcceptance(TestCase):
    ...
    def test_public_album_all_pictures_are_public(self):
        ...
        for picture in content['pictures']:
            self.assertEqual(picture['visibility'], BaseAlbum.VISIBILITY_PUBLIC)
    ...
    def test_make_picture_private(self):
        ...
        self.assertEqual(content['pictures'][0]['visibility'], BaseAlbum.VISIBILITY_PUBLIC)
        ...
        self.assertEqual(content['visibility'], BaseAlbum.VISIBILITY_PRIVATE)
    ...
    def test_make_picture_public(self):
        ...
        self.assertEqual(response3.status_code, 200)
        content = json.loads(response3.content)
        self.assertEqual(content['visibility'], BaseAlbum.VISIBILITY_PUBLIC)
        ...
        for f in content['pictures']:
            if f['filename'] == 'photo_2.JPG':
                photo = f
        self.assertEqual(photo['visibility'], BaseAlbum.VISIBILITY_PUBLIC)
